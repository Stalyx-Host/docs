...
<div className="relative">
  <div className="absolute -top-14 left-0 right-0 opacity-80">
    <img src="https://refractcdn.xyz/0gwXxIF/imageedit_3_4101780843.jpg" className="pointer-events-none w-full h-auto" />
  </div>
  ...
  <div className="relative z-10 px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Quickstart" description="Deploy your first docs site in minutes" href="/quickstart" />

      <HeroCard filename="cli" title="CLI installation" description="Install the CLI to preview docs locally" href="/installation" />

      <HeroCard filename="editor" title="Web editor" description="Make quick updates in the browser" href="/editor" />

      <HeroCard filename="components" title="Components" description="Build rich, interactive documentation" href="/components" />
    </div>
  </div>
</div>